...
#-implementacia modelu do adresara kde je appka pod adresar models
...
class BackgroundRemoveApp(tk.Tk):
    def __init__(self):
        ...
        self.set_window_geometry(600, 400)

        # Zistenie absolútnej cesty k priečinku, v ktorom sa nachádza skript 1.v poradi
        self.script_dir = os.path.dirname(os.path.abspath(__file__))

         # Cesta k lokálnemu modelu 2.v poradi
        self.model_path = os.path.join(self.script_dir, "models", "u2net.onnx")

        # Vytvorenie session pre rembg 3.vporadi
        self.session = new_session(model_path=self.model_path)
    ...
    def load_image(self):
        ...
        try:
            ...
            output_data = remove(input_data, session=self.session)                  #nacitanie lokalneho modelu v adresary models
